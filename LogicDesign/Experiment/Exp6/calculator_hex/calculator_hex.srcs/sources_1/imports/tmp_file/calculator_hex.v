module calculator_hex (input wire clk,
    ...
    always @(*) begin  // cal_result
        if (~rst_n)
            ...
            case(func_delay)
                3'd0: cal_result    = prev_result + num2_delay; // add
                3'd1: cal_result    = prev_result - num2_delay; // substract
                3'd2: cal_result    = prev_result * num2_delay; // time
                3'd3: cal_result    = prev_result / num2_delay; // divide
                3'd4: cal_result    = prev_result % num2_delay; // mod
